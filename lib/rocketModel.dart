...
List<RocketModel> rocketModelFromJson(String str) => List<RocketModel>.from(json.decode(str).map((x) => RocketModel.fromJson(x)));

String rocketModelToJson(List<RocketModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
